...
function App() {
  const [page, setPage] = useState<'overview' | 'path'>('overview')

  return (
    <div className="shell">
      <header className="topbar">
        <div className="logo">可爱天气地图</div>
        <nav className="nav">
          <button
          ...
          <button
            className={page === 'path' ? 'nav-link active' : 'nav-link'}
        ...
        <main className="page overview">
          <section className="hero">
            ...
            <div className="cta-row">
              <button className="primary" onClick={() => setPage('path')}>
                查看网站的开发路径
              </button>
              <button className="ghost" onClick={() => setPage('path')}>
                直接进入详情
              </button>
            </div>
          </section>
          ...
          <section className="card compact">
            ...
            <p className="body">
              通过雪景模式、极值展示和个人卡片，帮助用户毫不费力地生成“朋友圈截图素材”，让产品自带传播力。
            </p>
          </section>
        </main>
      )}
      ...
      {page === 'path' && (
        <main className="page path">
          <header className="hero">
            <p className="eyebrow">路线图 · 设计与功能对齐</p>
            <h1>网站的开发路径</h1>
            <p className="lede">
              梳理 MVP 的功能包、趣味模式和首周传播节奏，确保产品体验与传播目标一脉相承。
            </p>
          </header>
